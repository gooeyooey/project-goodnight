	...
	return (
		<Container>
			...
			<Card>
				...
				<br />
				Howdy! My name is Gooey. I’m an artist who likes humans and computers,
				in that order.
				<br />
				...
				<ul>
					<li>
						I’m from California, but I’m going to college in Boston,
						Massachusetts.
					</li>
					...
					<li>
						Estoy aprendiendo español, pero todavía no soy muy bueno. ¿Quieres
						practicar conmigo?
					</li>

					<li>
						I am the proud father of a twenty gallon aquarium. It’s not much,
						but they’re happy.
					</li>
				</ul>
				<br />
				...
				<ul>
					...
					<li>
						Mail:{" "}
						<a href="mailto:gooeyooey00@gmail.com">gooeyooey00@gmail.com</a>
					</li>
				</ul>
			</Card>
		</Container>
