...
export default function Page() {
  ...
  return (
    <Canvas>
      <Panel source="/story/3/1.png" position="1 / 1 / 9 / 13" display={current_step > 0} />
      <Panel source="/story/3/2.png" position="9 / 1 / 17 / 13" display={current_step > 1} />
      <Panel source="/story/3/3.png" position="17 / 1 / 31 / 13" display={current_step > 2} />
      <Panel source="/story/3/4.png" position="31 / 1 / 39 / 13" display={current_step > 3} />
      <Panel source="/story/3/5.png" position="39 / 1 / 49 / 6" display={current_step > 4} />
      <Panel source="/story/3/6a.png" position="39 / 6 / 49 / 13" display={current_step > 5} />
      <Panel source="/story/3/6b.png" position="39 / 6 / 49 / 13" display={current_step > 6} />
      <Panel source="/story/3/6c.png" position="39 / 6 / 49 / 13" display={current_step > 7} />
      <Panel source="/story/3/7a.png" position="49 / 1 / 60 / 13" display={current_step > 8} />
      <Panel source="/story/3/7b.png" position="49 / 1 / 60 / 13" display={current_step > 9} />
    </Canvas>
  );
}
